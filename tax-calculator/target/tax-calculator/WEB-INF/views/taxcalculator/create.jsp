...
<form:form action="store" modelAttribute="taxcalculator">
    ...
    <label for="zone">Choosse Zone </label>
    <br>
    ...
    <table border="1">
        ...
        <tr>
            <td>Festible Bonus</td>
            <td><form:input path="bonus" id="bonus"/><form:errors path="bonus"/></td>
        </tr>
